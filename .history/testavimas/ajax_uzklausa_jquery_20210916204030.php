...
<body>
    ...
    <i class="fa fa-arrow-up desc" id="desc-knygos-ID"></i>
    <i class="fa fa-arrow-down asc" id="asc-knygos-ID "></i>
    ...
    <i class="fa fa-arrow-up desc" id="desc-autoriai-pavadinimas"></i>
