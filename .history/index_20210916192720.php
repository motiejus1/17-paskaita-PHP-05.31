...
<body>
    <div class="container">
        <table class="table table-striped">
            ...
            <tr>
                <th class="sort-heading" id="id-asc">ID <i class="fa fa-arrow-up"></i><i class="fa fa-arrow-down"></i></th>
                <th class="sort-heading" id="pavadinimas-asc">Pavadinimas <i class="fa fa-arrow-up"></i><i class="fa fa-arrow-down"></i></th>
                <th class="sort-heading" id="santrauka-asc">Santrauka <i class="fa fa-arrow-up"></i><i class="fa fa-arrow-down"></i></th>
                <th class="sort-heading" id="vardas-asc">Autoriaus vardas <i class="fa fa-arrow-up"></i><i class="fa fa-arrow-down"></i></th>
                <th class="" id="pavarde-asc">Autoriaus pavardė <i class="fa fa-arrow-up"></i><i class="fa fa-arrow-down"></i></th>
            </tr>
