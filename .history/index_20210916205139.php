...
<body>
    <div class="container">
        <table class="table table-striped">
            ...
            <tr>
                <th class="sort-heading">ID 
                    <i class="fa fa-arrow-up" id="desc-knygos-ID"></i>
                    <i class="fa fa-arrow-down" id="desc-knygos-ID"></i>
                </th>
                ...
                <th class="sort-heading" id="pavarde-asc">Autoriaus pavardė 
                    <i class="fa fa-arrow-up"></i>
                    <i class="fa fa-arrow-down"></i>
                </th>
            </tr>
